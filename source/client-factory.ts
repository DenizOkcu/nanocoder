...
export async function createLLMClient(
	...
	// Use Genkit - it handles both tool-calling and non-tool-calling models
	return createGenkitClient(provider, hasConfigFile);
}

async function createGenkitClient(
	...
	for (const providerType of providerOrder) {
		try {
			...
			const client = await GenkitClient.create(providerConfig);
